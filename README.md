...
**Documentation:** For a full breakdown of the mathematical mapping, the Neuro-Coherence ($M$) Function, and real-world metabolic penalties, please read the [Domain Parkinson's Research Documentation](research_interfaces/PARKINSONS/PARKINSONS.md).

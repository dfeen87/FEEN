...
void test_single_step() {
    ...
    // Inline expected calculation to avoid unused variable warning in Release mode
    CHECK(std::abs(metric.delta_v() - std::exp(-0.1)) < 1e-6, "Single step delta_v mismatch");

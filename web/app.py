...
# Ensure we can import from python/ directory and from web/ directory
...
# Register the Hardware Link Bluetooth bridge as a Blueprint
from hardware_bridge import hardware_bp  # noqa: E402
